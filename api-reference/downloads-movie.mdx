...
api: "GET https://missourimonster-vyla.hf.space/api/downloads/movie/{tmdb_id}"
...
const res  = await fetch('https://missourimonster-vyla.hf.space/api/downloads/movie/550');
...
data = requests.get(
  'https://missourimonster-vyla.hf.space/api/downloads/movie/550'
).json()
