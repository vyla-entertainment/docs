...
api: "GET https://missourimonster-vyla-v3.hf.space/api/subtitles/movie/{tmdb_id}"
authMethod: "bearer"
...
const subtitles = await fetch(
  'https://missourimonster-vyla-v3.hf.space/api/subtitles/movie/550',
...
<script>
  fetch('https://missourimonster-vyla-v3.hf.space/api/subtitles/movie/550', {
    headers: { 'Authorization': 'Bearer YOUR_API_KEY' }
  })
    .then(r => r.json())
    .then(subs => {
