...
api: "GET https://api.vyla.cc/api/subtitles/movie/{tmdb_id}"
authMethod: "bearer"
...
<CodeGroup>
```bash cURL
curl https://api.vyla.cc/api/subtitles/movie/550 \
  --header "Authorization: Bearer YOUR_API_KEY"
```

```javascript JavaScript
const subtitles = await fetch(
  'https://api.vyla.cc/api/subtitles/movie/550',
...
<script>
  fetch('https://api.vyla.cc/api/subtitles/movie/550', {
    headers: { 'Authorization': 'Bearer YOUR_API_KEY' }
  })
    .then(r => r.json())
    .then(subs => {
