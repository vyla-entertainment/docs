...
<ParamField query="source" type="string" required>
  ...
  Available keys are listed in the `sources` field of [`/api/health`](https://missourimonster-vyla.hf.space/api/health) or [`/api/sources`](https://missourimonster-vyla.hf.space/api/sources).
</ParamField>
