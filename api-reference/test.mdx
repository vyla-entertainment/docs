...
<ParamField query="source" type="string" required>
  ...
  Available keys are listed in the `sources` field of [`/api/health`](https://missourimonster-vyla-api.hf.space/api/health) or [`/api?sources_meta=1`](https://missourimonster-vyla-api.hf.space/api?sources_meta=1).
</ParamField>
