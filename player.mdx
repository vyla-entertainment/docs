...
<Note>
  This player runs entirely in your browser against the live API. Source count and availability vary in real time depending on which providers are up. Check [/health](https://api.vyla.cc/health) if you see zero sources.
</Note>
...
<iframe
  src="https://player.vyla.cc/?id=8363"
...
```html
<iframe
  src="https://player.vyla.cc/?id=1396&season=1&episode=1"
  width="100%"
  style="aspect-ratio: 16/9; border: none; border-radius: 8px;"
  allow="autoplay; fullscreen"
></iframe>
